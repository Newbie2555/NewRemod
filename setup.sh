...
fsidvpn="raw.githubusercontent.com/Newbie2555/NewRemod/main/ssh"
# Link Hosting Kalian Untuk Xray
fsidvpnn="raw.githubusercontent.com/Newbie2555/NewRemod/main/xray"
# Link Hosting Kalian Untuk Backup
#fsidvpnnn="autosc.me/s/backup"
# Link Hosting Kalian Untuk Websocket
fsidvpnnnn="raw.githubusercontent.com/Newbie2555/NewRemod/main/websocket"
...
echo "1.2" > /home/ver
echo " "
echo "Succes Install AutoScript By WaanProject"
echo " "
echo "=================================-AutoScript By WaanProject-===========================" | tee -a log-install.txt
...
echo "   - Recode                  : WaanProject" | tee -a log-install.txt
echo "   - Telegram                : https://t.me/FER1DEV"  | tee -a log-install.txt
echo "   - Instagram               : Kosong"  | tee -a log-install.txt
echo "   - Whatsapp                : +6282323704490"  | tee -a log-install.txt
echo "   - Facebook                : kosong" | tee -a log-install.txt
echo "-----------------AutoScript By WaanProject-----------------" | tee -a log-install.txt
echo ""
